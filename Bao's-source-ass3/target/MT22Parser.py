    ...
    def fun_call(self):
        ...
        try:
            ...
            if token in [MT22Parser.IDENTIFIERS]:
                ...
                self.match(MT22Parser.RP)
                pass
            elif token in [MT22Parser.READ_INTEGER, MT22Parser.PRINT_INTEGER, MT22Parser.READ_FLOAT, MT22Parser.PRINT_FLOAT, MT22Parser.READ_BOOLEAN, MT22Parser.PRINT_BOOLEAN, MT22Parser.READ_STRING, MT22Parser.PRINT_STRING, MT22Parser.SUPER, MT22Parser.PREVENT_DEFAULT]:
                self.enterOuterAlt(localctx, 2)
                self.state = 410
    ...
    def special_function(self):
        ...
        try:
            ...
            if token in [MT22Parser.READ_INTEGER]:
                ...
                self.readFloat()
                pass
            elif token in [MT22Parser.PRINT_FLOAT]:
                self.state = 488
                self.printFloat()
                pass
