...
@dataclass
class ArrayLiteral(Literal): # [1,2,3,4]
    value: List[Literal]
    def __str__(self):
...
@dataclass
class ArrayType(Type): # number a[2, 3, 4]
    size : List[int]
    eleType:Type
    def __str__(self):
