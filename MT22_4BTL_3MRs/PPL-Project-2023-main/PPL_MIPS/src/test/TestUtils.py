...
class TestCodeGen():
    ...
    def check(soldir,asttree,num):
        ...
        try:
            ...
            proccess = subprocess.run("java  -jar "+ MARS_JAR + " " + path + "/main.asm" + " io.asm",shell=True,stderr=subprocess.STDOUT, stdout=subprocess.PIPE)
            output = proccess.stdout.decode('utf-8')
